...
// 				Husnain
// 				window.scroll(0, jQuery(window).scrollTop() - 75);
				var h_new_width = document.body.clientWidth;
				if(h_new_width > 575){
					window.scrollTo({
...
// 				Husnain + 250
                let top = viewportOffset.top + 450;  //  get the offset top
                if(top < windowHeight){  //  if the top offset is less than the window height
                    allElements[i].classList.add('in-viewport');  //  add the class
// 					alert(top + " top and height " + windowHeight);
                } else{
    ...
    document.getElementById('dot-nav').style.top = 'calc(52% - ' + hNavHeight + 'px)';
