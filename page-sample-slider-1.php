			...
			<?php
				...
				<div class="row px-sm-0 px-2 mx-auto">
					<div class="col-md-10 pb-md-3 pb-0 explore_text lower-heading text-center mx-auto advantage-heading">
						<h3>CUSTOMER TESTIMONIALS ON MOBILE 1</h3>
						<br>
					</div>
				</div>
...
<section class="use-case assivo-help pt-5">
		<div class="container">
			...
			<?php
				...
				<div class="row px-sm-0 px-2 mx-auto">
					<div class="col-md-10 pb-md-3 pb-0 explore_text lower-heading text-center mx-auto advantage-heading">
						<h3>CUSTOMER TESTIMONIALS ON MOBILE 2</h3>
						<br>
					</div>
				</div>
		
				<div id="myCarousel2" class="carousel slide header-fixed" data-ride="carousel" data-interval="0">
					<div class="d-block">
					<?php $i=1; ?>
					<div class="row pb-md-4 data-entry-tabs">
						<ul class="nav carousel-inner">
			...
			<!-- Carousel controls -->
					<div class="owl-nav customNav">
					<button type="button" role="presentation" class="carousel-control-prev h-carousel-pre" href="#myCarousel2" data-slide="prev">
						<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/prev_slide.png">
					</button>
					<button type="button" role="presentation" class="carousel-control-next h-carousel-next" href="#myCarousel2" data-slide="next">
						<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/next_slide.png">
					</button>
					</div>
		</div>
...
<section class="pt-5">
		<div class="container">
			...
			<?php
				...
				<div class="row px-sm-0 px-2 mx-auto">
					<div class="col-md-10 pb-md-3 pb-0 explore_text lower-heading text-center mx-auto advantage-heading">
						<h3>CUSTOMER TESTIMONIALS ON MOBILE 3</h3>
						<br>
					</div>
				</div>
		
				<div id="myCarousel3" class="carousel slide header-fixed" data-ride="carousel" data-interval="0">
					<?php $i=1; ?>
					<div class="row pb-md-4 data-entry-tabs">
						<ul class="nav carousel-inner">
							<?php foreach ( $myposts as $post ) : setup_postdata( $post ); ?>
			...
			<!-- Carousel controls -->
					<div class="owl-nav customNav">
					<button type="button" role="presentation" class="carousel-control-prev h-carousel-pre" href="#myCarousel3" data-slide="prev">
						<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/prev_slide.png">
					</button>
					<button type="button" role="presentation" class="carousel-control-next h-carousel-next" href="#myCarousel3" data-slide="next">
						<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/next_slide.png">
					</button>
					</div>
		</div>
